...
async function checkIP() {
    ...
    if (allowedIP) {
        window.location.href = 'index.html'; // Rediriger vers chat.html si IP autorisée
    } else {
...
function submitUsername() {
    ...
    .then(result => {
        ...
        if (result === 'success') {
            window.location.href = 'index.html'; // Rediriger vers chat.html après l'enregistrement
        } else {
